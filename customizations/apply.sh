...
const val MTS_PROVIDER_URL = "https://cdn.jsdelivr.net/gh/muhamadakmal854-svg/Provider@builds/repo.json"
...
const val MTS_VERSION_URL = "https://raw.githubusercontent.com/muhamadakmal854-svg/MTSFlix/main/version.json"
KTEOF
