...
class TVPairingActivity : AppCompatActivity() {
    ...
    companion object {
        private const val PAIR_URL_BASE = "https://raw.githack.com/muhamadakmal854-svg/MTSFlix/main/pair/index.html"
    ...
    private fun startPairing() {
        ...
        Thread {
            try {
                ...
                val shortUrl = "raw.githack.com/muhamadakmal854-svg/\nMTSFlix/main/pair/?code=$pairingCode\n&gist=$newGistId"
